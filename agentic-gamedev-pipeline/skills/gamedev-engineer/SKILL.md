...
Implement the assigned behavior within the supplied write boundary. Preserve unrelated changes and approved authority files. Add or update tests tightly coupled to changed behavior, run the assigned checks, and inspect the final diff for correctness, scope, lifecycle effects, and accidental cleanup.
